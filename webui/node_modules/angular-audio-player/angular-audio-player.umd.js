(function (global, factory) {
	...
	(factory((global['angular-audio-player'] = global['angular-audio-player'] || {}),global._angular_core,global.rxjs));
...
var AudioPlayerComponent = (function () {
    function AudioPlayerComponent() {
        this.mp3 = '';
        this.downloadUrl = '';
        this.state$ = new rxjs.BehaviorSubject('pause');
...
AudioPlayerComponent.propDecorators = {
    'mp3': [{ type: _angular_core.Input },],
    'downloadUrl': [{ type: _angular_core.Input },],
};
