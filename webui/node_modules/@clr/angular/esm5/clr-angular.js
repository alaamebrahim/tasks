...
import { Directive, NgModule, EventEmitter, Input, Output, TemplateRef, ViewContainerRef, Injectable, Component, Optional, SkipSelf, ViewChild, ContentChildren, ElementRef, HostListener, QueryList, Inject, PLATFORM_ID, Renderer2, HostBinding, forwardRef, ChangeDetectorRef, NgZone, ContentChild, IterableDiffers, InjectionToken, Injector, ComponentFactoryResolver } from '@angular/core';
...
var Popover = (function () {
    ...
    Popover.prototype.removeScrollEventListeners = function () {
        try {
            for (var _a = tslib_1.__values(this.scrollableElements), _b = _a.next(); !_b.done; _b = _a.next()) {
                var elem = _b.value;
...
ClrFormsModule.decorators = [
    { type: NgModule, args: [{ imports: [CommonModule], exports: [ClrCommonFormsModule, ClrCheckboxModule] },] },
];
/** @nocollapse */
...
var FiltersProvider = (function () {
    ...
    FiltersProvider.prototype.hasActiveFilters = function () {
        try {
            ...
            for (var _a = tslib_1.__values(this._all), _b = _a.next(); !_b.done; _b = _a.next()) {
...
var NestedProperty = (function () {
    ...
    NestedProperty.prototype.getPropValue = function (item) {
        if (this.splitProp) {
            var /** @type {?} */ value = item;
            try {
                for (var _a = tslib_1.__values(this.splitProp), _b = _a.next(); !_b.done; _b = _a.next()) {
