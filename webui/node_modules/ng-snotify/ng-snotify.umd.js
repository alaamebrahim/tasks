...
function SetToastType(target, propertyKey, descriptor) {
    return {
        value: function () {
            ...
            (/** @type {?} */ (args[0])).config = __assign$1({}, (/** @type {?} */ (args[0])).config, { type: propertyKey });
