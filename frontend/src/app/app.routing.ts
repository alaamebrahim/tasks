...
export const routes: Routes = [
    {
        ...
        component: PagesComponent, children: [
            { path: '', loadChildren: 'app/pages/dashboard/dashboard.module#DashboardModule', data: { breadcrumb: 'الرئيسية' } },
            { path: 'users', loadChildren: 'app/pages/users/users.module#UsersModule', data: { breadcrumb: 'المستخدمين' } },
            ...
            { path: 'mailbox', loadChildren: 'app/pages/mailbox/mailbox.module#MailboxModule', data: { breadcrumb: 'البريد الالكترونى' } },
