...
import { ComposedMail } from './compose/composed-mail.model';
/*
let Mails = [
    new Mail(
        1,
...
export class MailboxService {
    ...
    public sendMail(mail: ComposedMail) {
        return this.apiRequestService.post('mailbox/send-mail', mail);
    }
    ...
    public updateReadStatus(mail: Mail) {
        return this.apiRequestService.put('mailbox/set-mail-read-status', mail);
    }

    public updateStarStatus(mail: Mail) {
        return this.apiRequestService.put('mailbox/set-mail-star-status', mail);
    }

    public moveToTrash(mail: Mail) {
        return this.apiRequestService.put('mailbox/set-mail-trash-status', mail);
    }
}
