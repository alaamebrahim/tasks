...
<body width="100%" style="margin: 0; mso-line-height-rule: exactly; background-color: #22695c;">
    ...
    <![endif]-->
        ...
        <div style="display: none; font-size: 1px; line-height: 1px; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden; mso-hide: all; font-family: sans-serif;">
            {{ trans('messages.notifications.mail.message',['title' => $data['title']]) }}
        </div>
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="600" style="margin: auto;" class="email-container">
            <tr>
                <td style="padding: 20px 0; text-align: center; color: white; font-size: 22px">
                    {{trans('messages.notifications.mail.subject')}}
                </td>
            </tr>
        </table>
        <!-- Email Header : END -->
                    ...
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                            <td style="padding: 40px 40px 20px; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555; text-align:right;">
                                <h1 style="margin: 0 0 10px; font-size: 24px; line-height: 125%; color: #333333; font-weight: normal; text-align:right;">{{$data['title']}}</h1>
                                <p style="margin: 0 0 10px; text-align:right;">{{$data['start_date'] . ' : ' . $data['end_date']}}</p>
                                <p style="margin: 0 0 10px; text-align:right;">{{$data['description']}}</p>
