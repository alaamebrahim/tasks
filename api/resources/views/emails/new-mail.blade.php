        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="600" style="margin: auto;" class="email-container">
            <tr>
                <td style="padding: 20px 0; text-align: center; color: white; font-size: 22px">
                    <div style="text-align: center;">{{ trans('messages.site-name') }}</div>
                    <div style="text-align: center;"><p>{{ trans('messages.notifications.mail.new-mail') }}</p></div>
                </td>
            </tr>
        </table>
        <!-- Email Header : END -->
                    ...
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                            <td style="padding: 40px 40px 20px; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555; text-align:right;">
                                <h1 style="margin: 0 0 10px; font-size: 24px; line-height: 125%; color: #333333; font-weight: normal; text-align:right;"><h3>{{ $mailbox['subject'] }}</h3></h1>
                                <p style="margin: 0 0 10px; text-align:right;"><h4>من {{ $mailbox['sender']['first_name'] }} {{ $mailbox['sender']['last_name'] }}</h4></p>
                                <p style="margin: 0 0 10px; text-align:right;">{!! $mailbox['message'] !!}</p>
